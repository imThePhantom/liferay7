...
/**
 * Provides the local service utility for OrderItem. This utility wraps
 * {@link com.nabook.service.impl.OrderItemLocalServiceImpl} and is the
 ...
 * @see com.nabook.service.base.OrderItemLocalServiceBaseImpl
 * @see com.nabook.service.impl.OrderItemLocalServiceImpl
 * @generated
 */
@ProviderType
public class OrderItemLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.nabook.service.impl.OrderItemLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.nabook.model.OrderItem addOrderItem(
		com.nabook.model.OrderItem orderItem) {
		return getService().addOrderItem(orderItem);
	}
	...
	*/
	public static com.nabook.model.OrderItem createOrderItem(long orderItemId) {
		return getService().createOrderItem(orderItemId);
	}
	...
	*/
	public static com.nabook.model.OrderItem deleteOrderItem(
		com.nabook.model.OrderItem orderItem) {
		return getService().deleteOrderItem(orderItem);
	}
	...
	*/
	public static com.nabook.model.OrderItem deleteOrderItem(long orderItemId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteOrderItem(orderItemId);
	}

	public static com.nabook.model.OrderItem fetchOrderItem(long orderItemId) {
		return getService().fetchOrderItem(orderItemId);
	}
	...
	*/
	public static com.nabook.model.OrderItem fetchOrderItemByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchOrderItemByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a order item with the primary key could not be found
	*/
	public static com.nabook.model.OrderItem getOrderItem(long orderItemId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getOrderItem(orderItemId);
	}
	...
	*/
	public static com.nabook.model.OrderItem getOrderItemByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getOrderItemByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static com.nabook.model.OrderItem updateOrderItem(
		com.nabook.model.OrderItem orderItem) {
		return getService().updateOrderItem(orderItem);
	}
	...
	*/
	public static int getOrderItemsCount() {
		return getService().getOrderItemsCount();
	}
	...
	*/
	public static java.util.List<com.nabook.model.OrderItem> getOrderItems(
		int start, int end) {
		return getService().getOrderItems(start, end);
	}
	...
	*/
	public static java.util.List<com.nabook.model.OrderItem> getOrderItemsByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().getOrderItemsByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<com.nabook.model.OrderItem> getOrderItemsByUuidAndCompanyId(
		...
		return getService()
				   .getOrderItemsByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	...
	public static OrderItemLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<OrderItemLocalService, OrderItemLocalService> _serviceTracker =
		ServiceTrackerFactory.open(OrderItemLocalService.class);
}