...
public interface BookstoreLocalService extends BaseLocalService,
	...
	*/
	...
	public Bookstore addBookstore(ServiceContext serviceContext, long userId,
		...
		java.lang.String description) throws PortalException, SystemException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Bookstore> getAllBookstores(int start, int end)
		throws SystemException, NoSuchBookstoreException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Bookstore> getBookstoresByLocation(long companyId,
		java.lang.String country, java.lang.String city,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Bookstore> search(long companyId, java.lang.String keywords)
