...
import com.nabook.model.impl.CartImpl;
import com.nabook.model.impl.CartModelImpl;
 ...
 * @author phantoan
 * @see CartPersistence
 * @see com.nabook.service.persistence.CartUtil
 * @generated
 */
@ProviderType
public class CartPersistenceImpl extends BasePersistenceImpl<Cart>
	 ...
	 */
	@Override
	public Cart[] findByUuid_PrevAndNext(long cartId, String uuid,
		OrderByComparator<Cart> orderByComparator) throws NoSuchCartException {
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, CartImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			CartModelImpl.UUID_COLUMN_BITMASK |
			CartModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((cart.getUuid() == null) ||
							!cart.getUuid().equals(uuid) ||
							(cart.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, cart);
					}
				}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "cart.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "cart.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(cart.uuid IS NULL OR cart.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "cart.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, CartImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, CartImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			CartModelImpl.UUID_COLUMN_BITMASK |
			CartModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Cart> findByUuid_C(String uuid, long companyId, int start,
		int end) {
	 ...
	 */
	@Override
	public Cart findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Cart> orderByComparator) throws NoSuchCartException {
	 ...
	 */
	@Override
	public Cart fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Cart> orderByComparator) {
		List<Cart> list = findByUuid_C(uuid, companyId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Cart findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<Cart> orderByComparator) throws NoSuchCartException {
	 ...
	 */
	@Override
	public Cart fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<Cart> orderByComparator) {
		...
		List<Cart> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Cart[] findByUuid_C_PrevAndNext(long cartId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, cart, uuid, companyId,
					orderByComparator, true);

			array[1] = cart;

			array[2] = getByUuid_C_PrevAndNext(session, cart, uuid, companyId,
					orderByComparator, false);
	...
	protected Cart getByUuid_C_PrevAndNext(Session session, Cart cart,
		String uuid, long companyId, OrderByComparator<Cart> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (Cart cart : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(cart);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "cart.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "cart.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(cart.uuid IS NULL OR cart.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "cart.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, CartImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Cart> findByUserId(long userId, int start, int end) {
	...
	public Cart findByUserId_First(long userId,
		OrderByComparator<Cart> orderByComparator) throws NoSuchCartException {
		Cart cart = fetchByUserId_First(userId, orderByComparator);
	...
	public Cart fetchByUserId_First(long userId,
		OrderByComparator<Cart> orderByComparator) {
		List<Cart> list = findByUserId(userId, 0, 1, orderByComparator);
	...
	public Cart findByUserId_Last(long userId,
		OrderByComparator<Cart> orderByComparator) throws NoSuchCartException {
		Cart cart = fetchByUserId_Last(userId, orderByComparator);
	...
	public Cart fetchByUserId_Last(long userId,
		...
		List<Cart> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	...
	public Cart[] findByUserId_PrevAndNext(long cartId, long userId,
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(session, cart, userId,
					orderByComparator, true);

			array[1] = cart;

			array[2] = getByUserId_PrevAndNext(session, cart, userId,
					orderByComparator, false);
	...
	protected Cart getByUserId_PrevAndNext(Session session, Cart cart,
		long userId, OrderByComparator<Cart> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUserId(long userId) {
		for (Cart cart : findByUserId(userId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(cart);
		}
	}
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "cart.userId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_BOOKID = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, CartImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByBookId",
			new String[] { Long.class.getName(), Long.class.getName() },
			CartModelImpl.USERID_COLUMN_BITMASK |
			CartModelImpl.BOOKID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_BOOKID = new FinderPath(CartModelImpl.ENTITY_CACHE_ENABLED,
			CartModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Cart findByBookId(long userId, long bookId)
		throws NoSuchCartException {
		Cart cart = fetchByBookId(userId, bookId);
	...
	public Cart fetchByBookId(long userId, long bookId) {
		return fetchByBookId(userId, bookId, true);
	}
	...
	public Cart fetchByBookId(long userId, long bookId,
		boolean retrieveFromCache) {
		Object[] finderArgs = new Object[] { userId, bookId };
		...
		if (result instanceof Cart) {
			...
			if ((userId != cart.getUserId()) || (bookId != cart.getBookId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_BOOKID_USERID_2);
	...
	public Cart removeByBookId(long userId, long bookId)
		throws NoSuchCartException {
		Cart cart = findByBookId(userId, bookId);
	...
	private static final String _FINDER_COLUMN_BOOKID_USERID_2 = "cart.userId = ? AND ";
	private static final String _FINDER_COLUMN_BOOKID_BOOKID_2 = "cart.bookId = ?";
	...
	public void cacheResult(Cart cart) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_BOOKID,
			new Object[] { cart.getUserId(), cart.getBookId() }, cart);
	...
	public void clearCache(Cart cart) {
		...
		clearUniqueFindersCache((CartModelImpl)cart);
	}
	...
	protected void cacheUniqueFindersCache(CartModelImpl cartModelImpl,
		...
		if (isNew) {
			...
			args = new Object[] {
					cartModelImpl.getUserId(), cartModelImpl.getBookId()
				};
	...
	protected void clearUniqueFindersCache(CartModelImpl cartModelImpl) {
		Object[] args = new Object[] {
				cartModelImpl.getUuid(), cartModelImpl.getGroupId()
			};
		...
		args = new Object[] { cartModelImpl.getUserId(), cartModelImpl.getBookId() };
		...
		if ((cartModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					cartModelImpl.getOriginalBookId()
				};
	...
	public Cart updateImpl(Cart cart) {
		...
		if (isNew || !CartModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((cartModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { cartModelImpl.getOriginalUserId() };

				finderCache.removeResult(FINDER_PATH_COUNT_BY_USERID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID,
					args);

				args = new Object[] { cartModelImpl.getUserId() };
		...
		clearUniqueFindersCache(cartModelImpl);
		cacheUniqueFindersCache(cartModelImpl, isNew);
	...
	protected Cart toUnwrappedModel(Cart cart) {
		...
		cartImpl.setBookId(cart.getBookId());
		cartImpl.setQuantity(cart.getQuantity());
	...
	private static final String _SQL_SELECT_CART_WHERE_PKS_IN = "SELECT cart FROM Cart cart WHERE cartId IN (";
