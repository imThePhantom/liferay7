...
import com.nabook.service.AddressLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nabook.service.impl.AddressLocalServiceImpl}.
 * </p>
 *
 * @author phantoan
...
public abstract class AddressLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nabook.service.AddressLocalServiceUtil} to access the address local service.
	 */
	 ...
	 */
	@Override
	public List<Address> getAddressesByUuidAndCompanyId(String uuid,
		long companyId) {
	...
	public List<Address> getAddressesByUuidAndCompanyId(String uuid,
		...
		return addressPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.nabook.model.Address",
			addressLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.nabook.model.Address");
	}
