...
import com.nabook.model.impl.AuthorImpl;
import com.nabook.model.impl.AuthorModelImpl;
 ...
 * @see com.nabook.service.persistence.AuthorUtil
 * @generated
 */
@ProviderType
public class AuthorPersistenceImpl extends BasePersistenceImpl<Author>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(AuthorModelImpl.ENTITY_CACHE_ENABLED,
			...
			AuthorModelImpl.FULLNAME_COLUMN_BITMASK);
	...
	public void clearCache(Author author) {
		...
		clearUniqueFindersCache((AuthorModelImpl)author);
	}
	...
	public Author updateImpl(Author author) {
		...
		clearUniqueFindersCache(authorModelImpl);
		cacheUniqueFindersCache(authorModelImpl, isNew);
	...
	protected Author toUnwrappedModel(Author author) {
		...
		authorImpl.setFullName(author.getFullName());
		authorImpl.setProfile(author.getProfile());
	 ...
	 */
	@Override
	public List<com.nabook.model.Book> getBooks(long pk) {
	 ...
	 */
	@Override
	public List<com.nabook.model.Book> getBooks(long pk, int start, int end) {
	...
	@Override
	public List<com.nabook.model.Book> getBooks(long pk, int start, int end,
		OrderByComparator<com.nabook.model.Book> orderByComparator) {
	...
	public void addBook(long pk, long bookPK) {
		...
		if (author == null) {
			authorToBookTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, bookPK);
		}
		else {
			authorToBookTableMapper.addTableMapping(author.getCompanyId(), pk,
				bookPK);
		}
	}
	 ...
	 */
	@Override
	public void addBooks(long pk, List<com.nabook.model.Book> books) {
		addBooks(pk,
			ListUtil.toLongArray(books, com.nabook.model.Book.BOOK_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void removeBooks(long pk, List<com.nabook.model.Book> books) {
		removeBooks(pk,
			ListUtil.toLongArray(books, com.nabook.model.Book.BOOK_ID_ACCESSOR));
	}
	...
	public void setBooks(long pk, long[] bookPKs) {
		...
		authorToBookTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeBookPKsSet));
		...
		authorToBookTableMapper.addTableMappings(companyId, pk,
			ArrayUtil.toLongArray(newBookPKsSet));
	}
	 ...
	 */
	@Override
	public void setBooks(long pk, List<com.nabook.model.Book> books) {
		try {
			long[] bookPKs = new long[books.size()];

			for (int i = 0; i < books.size(); i++) {
				com.nabook.model.Book book = books.get(i);
	...
	public void afterPropertiesSet() {
		authorToBookTableMapper = TableMapperFactory.getTableMapper("nab_Books_Authors",
				"companyId", "authorId", "bookId", this, bookPersistence);
	}
	...
	protected TableMapper<Author, com.nabook.model.Book> authorToBookTableMapper;
