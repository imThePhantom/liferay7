...
create index IX_FA3548FE on nab_Book (author[$COLUMN_LENGTH:75$]);
...
create index IX_1BA5195A on nab_Bookstore (companyId);
create unique index IX_CC6836F7 on nab_Bookstore (country[$COLUMN_LENGTH:75$], city[$COLUMN_LENGTH:75$], prefecture[$COLUMN_LENGTH:75$], street[$COLUMN_LENGTH:75$]);
create unique index IX_4CDF434D on nab_Bookstore (name[$COLUMN_LENGTH:75$]);
